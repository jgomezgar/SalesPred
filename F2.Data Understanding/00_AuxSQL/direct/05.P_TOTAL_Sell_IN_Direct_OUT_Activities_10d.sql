/*###########################  1 min ##########################################*/
--OUTPUT: [STAGING_2].[dbo].XXX_P_TOTAL_Sell_IN_Direct_OUT_Activities_10d

--INPUT: [STAGING_2].[dbo].[XXX_P_Sell_IN_Direct_OUT_Activities_10d]
...
--		sum([PERC_TOTEM_ESP] ) [PERC_TOTEM_ESP] ,
	...
	into [STAGING_2].[dbo].XXX_P_TOTAL_Sell_IN_Direct_OUT_Activities_10d	
  FROM [STAGING_2].[dbo].[XXX_P_Sell_IN_Direct_OUT_Activities_10d] c0
...
;
SET @t2 = GETDATE();
SELECT '05.P_TOTAL_Sell_IN_Direct_OUT_Activities_10d.sql' as SCRIPT,
