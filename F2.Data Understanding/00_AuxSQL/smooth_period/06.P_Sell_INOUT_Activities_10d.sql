/*############################## 9 min #######################################*/
-- OUTPUT: [STAGING_2].[dbo].XXX_P_Sell_INOUT_Activities_10d

-- AUXILIARY OUTPUT:
--		[STAGING_2].[dbo].XXX_Sell_OUT_ITG

-- INPUT:
--		[STAGING_2].[dbo].[XXX_P_Sell_IN_Activities_10d]
...
IF OBJECT_ID('[STAGING_2].[dbo].XXX_P_Sell_INOUT_ITG_Activities_10d', 'U') IS NOT NULL
 DROP TABLE [STAGING_2].[dbo].XXX_P_Sell_INOUT_ITG_Activities_10d;		 
...
--      ,sia.[PERC_TOTEM_ESP]
      ...
      ,sia.[PERC_CUE]
      ,sia.[PERC_visit]
  into [STAGING_2].[dbo].XXX_P_Sell_INOUT_ITG_Activities_10d
  FROM [STAGING_2].[dbo].[XXX_P_Sell_IN_Activities_10d] sia
...
IF OBJECT_ID('[STAGING_2].[dbo].XXX_P_Sell_INOUT_Activities_10d', 'U') IS NOT NULL
 DROP TABLE [STAGING_2].[dbo].XXX_P_Sell_INOUT_Activities_10d;		 
...
Into [STAGING_2].[dbo].XXX_P_Sell_INOUT_Activities_10d
 from [STAGING_2].[dbo].XXX_P_Sell_INOUT_ITG_Activities_10d sia
 join MRKT_SO SO 
	   on sia.CUSTOMER_ID 	= SO.CUSTOMER_ID and
...
CREATE NONCLUSTERED INDEX [_dta_index_XXX_P_Sell_INOUT_Activities_10d_8_1952062040__K7_K2_K9_K10_3_4_5_6_8_11_12_13_14_15_16_17_18_19_20_21_22_23_24_25_] ON [dbo].[XXX_P_Sell_INOUT_Activities_10d] 
(
	[CAL_DATE] ASC,
	[tercio] ASC,
	[CUSTOMER_ID] ASC,
