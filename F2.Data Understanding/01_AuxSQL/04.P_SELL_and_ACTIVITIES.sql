/*################### 10 min #################################################*/
-- OUTPUT: [STAGING_2].[dbo].XXX_P_Sell_IN_Activities_10d 

-- AUXILIARY OUTPUT:
--		[STAGING_2].[dbo].XXX_P_invest_column
--		[STAGING_2].[dbo].XXX_P_Sell_IN_Periods_10d_rich_dates_VISITS

-- INPUT:
--		[STAGING_2].[dbo].XXX_P_Sell_IN_Periods_10d p 
--			[STAGING_2].[dbo].XXX_P_Sell_IN_ITG s
...
/*#########################################################################*/
IF OBJECT_ID('[STAGING_2].[dbo].XXX_P_Sell_IN_Periods_10d_rich_dates_VISITS', 'U') IS NOT NULL
 DROP TABLE [STAGING_2].[dbo].XXX_P_Sell_IN_Periods_10d_rich_dates_VISITS;
...
--	p.Midcategory,
	p.SI_ITG_WSE,
	p.SI_MRKT_WSE
from [STAGING_2].[dbo].XXX_P_Sell_IN_Periods_10d p

left join [STAGING_2].[dbo].XXX_P_Sell_IN_ITG s
...
/*#########################################################################*/
IF OBJECT_ID('[STAGING_2].[dbo].XXX_P_Sell_IN_Activities_10d', 'U') IS NOT NULL
 DROP TABLE [STAGING_2].[dbo].XXX_P_Sell_IN_Activities_10d;
...
into [STAGING_2].[dbo].XXX_P_Sell_IN_Activities_10d 
from [STAGING_2].[dbo].XXX_P_Sell_IN_Periods_10d_rich_dates_VISITS s 
