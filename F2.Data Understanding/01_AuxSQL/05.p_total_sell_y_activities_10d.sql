/*############################## 2 min ######################################*/
--OUTPUT: [STAGING_2].[dbo].XXX_P_TOTAL_Sell_IN_Activities_10d

--INPUT: [STAGING_2].[dbo].[XXX_P_Sell_IN_Activities_10d]
...
/*#########################################################################*/
IF OBJECT_ID('[STAGING_2].[dbo].XXX_P_TOTAL_Sell_IN_Activities_10d', 'U') IS NOT NULL
 DROP TABLE [STAGING_2].[dbo].XXX_P_TOTAL_Sell_IN_Activities_10d;
...
--		sum([PERC_TOTEM_ESP] ) [PERC_TOTEM_ESP] ,
	...
	into [STAGING_2].[dbo].XXX_P_TOTAL_Sell_IN_Activities_10d	
  FROM [STAGING_2].[dbo].[XXX_P_Sell_IN_Activities_10d] c0
