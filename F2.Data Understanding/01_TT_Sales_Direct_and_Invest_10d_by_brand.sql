...
,P_Sell_IN_Direct_OUT_Activities_10d as (
select  * from [STAGING_2].[dbo].XXX_P_Sell_IN_Direct_OUT_Activities_10d
...
union all
/*TOTAL included*/
select  * from [STAGING_2].[dbo].XXX_P_TOTAL_Sell_IN_Direct_OUT_Activities_10d
)
...
--  m.days_btwn_mean,
 ...
 --   C0.R R,
  ...
  isnull(C0.days_btw_order,99)   days_btw_order,
  C0.num_orders       num_orders,
  C0.DATE_init DATE_init,
  C0.DATE_end DATE_end,
...
from P_Sell_IN_Direct_OUT_Activities_10d C0
